...
Encoder knobMaster(2,3);
Encoder knobDiscord(5 , 6);
Encoder knobChrome(8,9);
Encoder knobGaming(11,12);
Encoder knobMusic(A2, A3);
...
const int masterButton=4;
const int discordButton=7;
const int chromeButton=10;
const int gamingButton=15;
